    ...
    <header className="fixed top-0 w-full z-50 bg-surface/90 backdrop-blur-md flex justify-between items-center px-8 py-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="bg-primary-container text-on-primary-container px-6 py-2 rounded-md font-label uppercase tracking-widest text-[10px] font-bold hover:brightness-110 active:scale-95 transition-all"
        >
          Đóng góp ký ức
        </button>
      </div>
